...
<body>
    ...
    <form name="registerForm" id="registerForm" action="" method="post">
        <table id="registrationTable">
            ...
            <tr>
                <td>Tên tài khoản</td>
                <td><label for="txtNewUsername"></label><input type="text" name="txtNewUsername" id="txtNewUsername"
                        value=""></td>
            </tr>
            <tr>
                <td>Email</td>
            ...
            <tr>
                <td>Mật khẩu</td>
                <td><label for="txtNewPassword"></label><input type="password" name="txtNewPassword" id="txtNewPassword"
                        value=""></td>
            </tr>
            <tr>
                <td>Xác nhận mật khẩu</td>
                <td><label for="txtConfirmPassword"></label><input type="password" name="txtConfirmPassword"
                        id="txtConfirmPassword" value=""></td>
            </tr>
            <tr>
                <td></td>
