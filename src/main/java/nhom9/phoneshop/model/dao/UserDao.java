...
public class UserDao extends BaseDao{
    ...
    public CustomerBean getCustomer(int CustomerID){
        CustomerBean customer = null;
        String sql = "SELECT * FROM customers INNER JOIN users ON customers.Username = users.Username INNER JOIN roles ON users.RoleID = roles.RoleID WHERE customers.CustomerID = ?";
        try{
            this.connect();
            var statement = this.getConnection().prepareStatement(sql);
